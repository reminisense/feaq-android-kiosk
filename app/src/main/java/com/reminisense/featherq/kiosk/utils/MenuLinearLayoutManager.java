...
/**
 * Created by RUFFY on 19 Nov 2015.
 */
public class MenuLinearLayoutManager extends LinearLayoutManager {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public MenuLinearLayoutManager(Context context, int orientation, boolean reverseLayout) {
        super(context, orientation, reverseLayout);
        this.view = null;
    }

    @SuppressWarnings("UnusedDeclaration")
    public MenuLinearLayoutManager(RecyclerView view) {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public MenuLinearLayoutManager(RecyclerView view, int orientation, boolean reverseLayout) {
